...
export class DocumentService {
  ...
  //   const file_url = await this.uploadFileSupabase(file);
  ...
  // private async uploadFileSupabase(file: Express.Multer.File): Promise<string> {
  //   try {
  ...
  // async getDocumentsByItineraryIdSupabase(itinerary_id: number, page: number) {
  ...
  // async deleteDocumentByIdSupabase(id: number) {
  //   try {
